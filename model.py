...
def simple_predict(home_stats, away_stats):
    ...
    raw_prob = 0.5 + wp_diff * 0.35 + (net_diff / 20) * 0.30 + l10_diff * 0.20 + venue_edge * 0.15
...
def main():
    print("BetEdge NBA Prediction Model v3")
    print("=" * 40)
    ...
    for g in games:
        ...
        home_odds = round((1 / book_home) * 0.95, 2)
        ...
        output_games.append({
            ...
            "home": {
                ...
                "pace": 98, "true_shooting": 0.570, "three_pct": 0.360, "injuries": []
            },
            "away": {
            ...
            "prediction": {
                ...
                "model_pick": model_pick, "confidence": confidence,
                "book_home_prob": round(book_home, 3), "book_away_prob": round(book_away, 3),
                "home_odds": home_odds, "away_odds": away_odds,
                "home_ev": ev_home, "away_ev": ev_away,
                "kelly_fraction": kelly, "value_bet": value_bet,
                "key_factors": get_key_factors(h_stats, a_stats, ha, aa)
            }
        })
