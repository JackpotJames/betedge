    ...
    for g in games:
        ...
        game_obj = {
            ...
            "home": {
                ...
                "offensive_rating": round(h_adv.get('ortg', 0) if h_adv and h_adv.get('ortg', 0) > 50 else h_season['pts_for'], 1),
                "defensive_rating": round(h_adv.get('drtg', 0) if h_adv and h_adv.get('drtg', 0) > 50 else h_season['pts_against'], 1),
                "net_rating": round(h_adv.get('net_rtg', 0) if h_adv and h_adv.get('ortg', 0) > 50 else h_season['diff'], 1),
                "efg": round(h_adv.get('efg', 0.52) if h_adv else 0.52, 3),
                "pace": round(h_adv.get('pace', 0) if h_adv and h_adv.get('pace', 0) > 50 else 98, 1),
                "rest_days": h_rest,
            ...
            "away": {
                ...
                "offensive_rating": round(a_adv.get('ortg', 0) if a_adv and a_adv.get('ortg', 0) > 50 else a_season['pts_for'], 1),
                "defensive_rating": round(a_adv.get('drtg', 0) if a_adv and a_adv.get('drtg', 0) > 50 else a_season['pts_against'], 1),
                "net_rating": round(a_adv.get('net_rtg', 0) if a_adv and a_adv.get('ortg', 0) > 50 else a_season['diff'], 1),
